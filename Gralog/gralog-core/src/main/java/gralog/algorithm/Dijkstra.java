...
public class Dijkstra extends Algorithm {
    ...
    public static void dijkstraShortestPath(Structure s, Vertex start,
        ...
        xd.graphElement(s); //Creates graph element
        ...
        while (!setQ.isEmpty()) {
            ...
            xd.iterationElement(u, setQ, distances); //Creates iteration element
        }
        xd.transformer(); //Applies transformer to save XML document
    }

    public static void dijkstraShortestPath(Structure s, Vertex start,
                                            HashMap<Vertex, Vertex> predecessor,
                                            HashMap<Vertex, Edge> edgeFromPredecessor,
                                            HashMap<Vertex, Double> distances) throws ParserConfigurationException, TransformerException {
        Dijkstra.dijkstraShortestPath(s, start, null, predecessor, edgeFromPredecessor, distances);
    }
    ...
    public Object run(Structure s, AlgorithmParameters p, Set<Object> selection,
        ...
        Dijkstra.dijkstraShortestPath(s, v, predecessor, edgeFromPredecessor, distances);
