...
public class BuechiLanguageEmptiness extends Algorithm  {
    ...
    public String languageEmptiness(BuechiAutomaton s) throws ParserConfigurationException, TransformerException {
    ...
    public Object run(BuechiAutomaton s, gralog.algorithm.AlgorithmParameters p,
        Set<Object> selection, ProgressHandler onprogress) throws ParserConfigurationException, TransformerException{
